...
namespace DataLibrary.Migrations
{
    ...
    [Migration("20230808085225_FCO Log models added")]
    partial class FCOLogmodelsadded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.Common.ApproverAssociation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("ApproverAssociations");
                });
            ...
            modelBuilder.Entity("Models.Common.Contractor", b =>
                {
                    ...
                    b.Property<double>("CompositeRate")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Models.FCOLog", b =>
                {
                    ...
                    b.Property<DateTime>("DesignatedCoordinationDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<long?>("EndorserBTLId")
                        .HasColumnType("bigint");

                    b.Property<long?>("EndorserUnitSuperindendantId")
                        .HasColumnType("bigint");

                    b.Property<DateTime>("EndorsmentBTLDate")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("EndorsmentUnitSuperindendantDate")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("EndorserBTLId");

                    b.HasIndex("EndorserUnitSuperindendantId");
            ...
            modelBuilder.Entity("Models.TimeOnTools.OngoingWorkDelay", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Models.WeldingRodRecord.FCOReason", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("FCOReasons");
                });

            modelBuilder.Entity("Models.WeldingRodRecord.FCOType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Models.FCOLog", b =>
                {
                    ...
                    b.HasOne("Models.ToranceUser", "DesignatedCoordinator")
                        .WithMany()
                        .HasForeignKey("DesignatedCoordinatorId");

                    b.HasOne("Models.ToranceUser", "Employee")
                        .WithMany()
                        .HasForeignKey("EmployeeId");

                    b.HasOne("Models.ToranceUser", "EndorserBTL")
                        .WithMany()
                        .HasForeignKey("EndorserBTLId");

                    b.HasOne("Models.ToranceUser", "EndorserUnitSuperindendant")
                        .WithMany()
                        .HasForeignKey("EndorserUnitSuperindendantId");
                    ...
                    b.Navigation("DesignatedCoordinator");

                    b.Navigation("Employee");

                    b.Navigation("EndorserBTL");

                    b.Navigation("EndorserUnitSuperindendant");
