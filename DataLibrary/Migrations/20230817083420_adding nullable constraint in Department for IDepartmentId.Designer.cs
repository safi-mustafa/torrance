...
namespace DataLibrary.Migrations
{
    ...
    [Migration("20230817083420_adding nullable constraint in Department for IDepartmentId")]
    partial class addingnullableconstraintinDepartmentforIDepartmentId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.FCOLog", b =>
                {
                    b.HasOne("Models.ToranceUser", "AreaExecutionLead")
                        .WithMany()
                        .HasForeignKey("AreaExecutionLeadId");

                    b.HasOne("Models.ToranceUser", "BusinessTeamLeader")
                        .WithMany()
                        .HasForeignKey("BusinessTeamLeaderId");
                    ...
                    b.HasOne("Models.WeldingRodRecord.FCOReason", "FCOReason")
                        .WithMany()
                        .HasForeignKey("FCOReasonId");

                    b.HasOne("Models.WeldingRodRecord.FCOType", "FCOType")
                        .WithMany()
                        .HasForeignKey("FCOTypeId");

                    b.HasOne("Models.ToranceUser", "Rejecter")
                        .WithMany()
                    ...
                    b.Navigation("AreaExecutionLead");

                    b.Navigation("BusinessTeamLeader");
