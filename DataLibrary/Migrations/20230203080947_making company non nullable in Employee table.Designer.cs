...
namespace DataLibrary.Migrations
{
    ...
    [Migration("20230203080947_making company non nullable in Employee table")]
    partial class makingcompanynonnullableinEmployeetable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.OverrideLogs.OverrideLog", b =>
                {
                    ...
                    b.Property<DateTime>("DateOfWorkCompleted")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<TimeSpan>("TimeSubmitted")
                        .HasColumnType("time");
            ...
            modelBuilder.Entity("Models.OverrideLogs.OverrideLogEmployee", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("OverrideLogEmployees");
                });
            ...
            modelBuilder.Entity("Models.OverrideLogs.OverrideLog", b =>
                {
                    ...
                    b.HasOne("Models.OverrideLogs.CraftRate", "CraftRate")
                        .WithMany()
                        .HasForeignKey("CraftRateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("Models.OverrideLogs.OverrideType", "OverrideType")
                        .WithMany()
            ...
            modelBuilder.Entity("Models.WeldingRodRecord.Employee", b =>
                {
                    b.HasOne("Models.Common.Contractor", "Company")
                        .WithMany()
