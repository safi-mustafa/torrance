...
namespace Web.Extensions
{
    public static class StartupExtension
    {
        ...
        public static void ConfigureDependencies(this IServiceCollection services)
        {
            ...
            services.AddScoped<IWeldMethodService, WeldMethodService>();
            services.AddScoped<IRodTypeService, RodTypeService>();
            services.AddScoped<IPermitTypeService, PermitTypeService>();
            services.AddScoped<IReworkDelayService, ReworkDelayService>();
            services.AddScoped<IShiftService, ShiftService>();
            services.AddScoped<IShiftDelayService, ShiftDelayService>();
            services.AddScoped<ISOWService, SOWService>();
            services.AddScoped<IWRRLogService, WRRLogService>();
            services.AddScoped<IEmployeeService, EmployeeService>();
            services.AddScoped<ITOTLogService, TOTLogService>();
